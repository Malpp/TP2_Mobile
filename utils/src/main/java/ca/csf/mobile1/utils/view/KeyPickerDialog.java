...
public final class KeyPickerDialog
{
	 ...
	 */
	public static KeyPickerDialog make(Context context,
	                                   int keyLength)
	{
		return new KeyPickerDialog(context, keyLength);
	}
	
	private KeyPickerDialog(Context context,
	                        int keyLength)
	{
		if (context == null)
		{
	...
	private void createView()
	{
		...
		GridLayout gridLayout = (GridLayout) layoutInflater.inflate(R.layout.view_key_picker_dialog,
		                                                            null);
		...
		dialogBuilder.setPositiveButton(android.R.string.ok,
		                                (dialog, which) -> onOkButtonClicked());
		dialogBuilder.setNegativeButton(android.R.string.cancel,
		                                (dialog, which) -> onCancelButtonClicked());
	}
	
	private void onArrowButtonClicked(int index,
	                                  int increment)
	{
